...
$html = $html -replace 'value="https://docs\.google\.com.*?pub\?gid=0&single=true&output=csv"', 'value="YOUR_APPS_SCRIPT_URL"'
...
$html | Set-Content '../dashboard/index.html' -Encoding UTF8
